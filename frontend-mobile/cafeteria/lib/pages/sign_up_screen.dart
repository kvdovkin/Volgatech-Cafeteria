...
class _LoginFormWidgetState extends State<LoginFormWidget> {
  var _isPasswordLengthCorrect = false;
  ...
  Future<void> _onRegisterPressed(BuildContext context) async {
    ...
    await loginModel.register(_nameController.text, _passwordController.text);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
          ...
          children: [
            ...
            Container(
              ...
              child: TextField(
                ...
                onChanged: (text) => {
                  setState(() {
                    _isPasswordLengthCorrect = text.length >= 6;
                  })
                },
                style: TextStyle(
        ...
        Opacity(
          opacity: _isPasswordLengthCorrect ? 1 : 0.5,
          child: Container(
            width: 350,
            height: 50,
            margin: EdgeInsets.symmetric(vertical: 5),
            child: MaterialButton(
              ...
              onPressed: () =>
                  _isPasswordLengthCorrect ? _onRegisterPressed(context) : null,
              child: Text(
                "Регистрация",
